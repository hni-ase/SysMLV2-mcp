...
inputSpec: sysmlv2-api-spec/openapi_client.yml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{B36316F0-1549-4CFB-84A0-CA1979D4F85F}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IBranchApi>();
            IDeleteBranchByProjectAndIdApiResponse apiResponse = await api.DeleteBranchByProjectAndIdAsync("todo");
            Branch? model = apiResponse.Ok();
        }
...
## Api Information
- appName: SysML v2 API and Services
- appVersion: 1.0.0
- appDescription: REST/HTTP binding (PSM) for the SysML v2 standard API.
